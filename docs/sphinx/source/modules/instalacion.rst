...
1. **Descargar Python**:
   - Visita `python.org <https://www.python.org/downloads/>`_
...
- `Guía de Inicio Rápido <../../../docs/README.md>`_ - Para comenzar a usar el sistema
- `Casos de Uso <../../../docs/casos_uso.md>`_ - Para ejemplos prácticos
- `Arquitectura del Proyecto <../../../docs/arquitectura_proyecto.md>`_ - Para entender la estructura

----

Si encuentras problemas durante la instalación, consulta la sección de `Preguntas Frecuentes <../../../docs/preguntas_frecuentes.md>`_ o crea un issue en el repositorio del proyecto.